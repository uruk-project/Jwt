...
//        /// Gets the 'expiration time' claim.
//        /// </summary>
//        public long? Exp => _inner.TryGetValue(WellKnownProperty.Exp, out var property) ? (long?)property.Value : null;

//        /// <summary>
//        /// Gets the 'JWT ID' claim.
//        /// </summary>
//        public string Jti => _inner.TryGetValue(WellKnownProperty.Jti, out var property) ? (string)property.Value : null;

//        /// <summary>
//        /// Gets the 'issued at' claim.
//        /// </summary>
//        public long? Iat => _inner.TryGetValue(WellKnownProperty.Iat, out var property) ? (long?)property.Value : null;

//        /// <summary>
//        /// Gets the 'issuer' claim.
//        /// </summary>
//        public string Iss => _inner.TryGetValue(WellKnownProperty.Iss, out var property) ? (string)property.Value : null;

//        /// <summary>
//        /// Gets the 'not before' claim.
//        /// </summary>
//        public long? Nbf => _inner.TryGetValue(WellKnownProperty.Nbf, out var property) ? (long?)property.Value : null;

//        /// <summary>
//        /// Gets the 'subject' claim.
//        /// </summary>
//        public string Sub => _inner.TryGetValue(WellKnownProperty.Sub, out var property) ? (string)property.Value : null;
