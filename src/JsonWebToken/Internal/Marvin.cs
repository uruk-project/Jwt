...
{
    // Based on the code published on 
    // https://github.com/dotnet/runtime/blob/79ae74f5ca5c8a6fe3a48935e85bd7374959c570/src/libraries/System.Private.CoreLib/src/System/Marvin.cs
    internal static partial class Marvin
    {
        ...
        InputTooSmallToEnterMainLoop:
            ...
            if ((count & 0b_0010) != 0)
            {
                ...
                {
                    partialResult |= (uint)Unsafe.ReadUnaligned<ushort>(ref data);
                    partialResult = RotateRight(partialResult, 16);
                }
            }
        ...
        private static void Block(ref uint rp0, ref uint rp1)
        {
            ...
            p1 ^= p0;
            p0 = RotateRight(p0, 20);

            p0 += p1;
            p1 = RotateRight(p1, 9);

            p1 ^= p0;
            p0 = RotateRight(p0, 27);

            p0 += p1;
            p1 = RotateRight(p1, 19);
