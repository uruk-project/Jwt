...
{
    /// <summary>Defines the valitation status of a JWT.</summary>
    public enum TokenValidationStatus
    {
        /// <summary>The token is valid.</summary>
        NoError = 0x00000000,

        /// <summary>A key error-related occurred.</summary>
        KeyError = 0x40000000,

        /// <summary>A claim error-related occurred.</summary>
        ClaimError = 0x20000000,

        /// <summary>A header error-related occurred.</summary>
        HeaderError = 0x10000000,

        /// <summary>A lifetime error-related occurred.</summary>
        LifetimeError = 0x08000000,

        /// <summary>A signature error-related occurred.</summary>
        SignatureError = 0x04000000,

        /// <summary>A decryption error occurred.</summary>
        DecryptionError = 0x02000000,

        /// <summary>A decompression error occurred.</summary>
        DecompressionError = 0x01000000,

        /// <summary>A duplication error occurred.</summary>
        DuplicationError = 0x00800000,

        /// <summary>A structural error occurred.</summary>
        ...
        /// <summary>The 'alg' header parameter is not supported.</summary>
        ...
        /// <summary>The 'crit' header defines a missing critical header.</summary>
