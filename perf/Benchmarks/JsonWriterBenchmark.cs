...
namespace JsonWebToken.Performance
{
    ...
    public class JsonWriterBenchmark
    {
        ...
        private static readonly PayloadDescriptor payload = new PayloadDescriptor(json);
        ...
        {
            return JwsDescriptor.Serialize(payload);
        }

        [Benchmark]
        public string Old()
        {
            return JsonConvert.SerializeObject(json, Formatting.None, serializerSettings);
        }
    }
}
#endif