...
namespace JsonWebToken.Tests
{
    public class JwksTests
    {
        ...
        private static string EmptyJwks = @"{""keys"":[]}";
        private static string SalesforceJwks = @"{
                    ""keys"": [
                    {
                        ""kty"": ""RSA"",
        ...
        private static string GoogleJwks = @"{
                    ""keys"": [
                        {
