...
namespace JsonWebToken.Tests
{
    public class JwksTests
    {
        ...
        private static readonly string EmptyJwks = @"{""keys"":[]}";
        private static readonly string SalesforceJwks = @"{
                    ""keys"": [
                    {
                        ""kty"": ""RSA"",
        ...
        private static readonly string GoogleJwks = @"{
                    ""keys"": [
                        {
...
#if NET462
        private static readonly string EveOnlineJwks = @"{
                    ""keys"": [
                        {
                            ""alg"": ""RS256"",
                            ""e"": ""AQAB"",
...
#else 
        private static string EveOnlineJwks = @"{
                    ""keys"": [
                        {
                            ""alg"": ""ES256"",
                            ""crv"": ""P-256"",
