        ...
        [InlineData("invalid x5u", @"
{
    ...
    ""x5u"": false
        ...
        {
            Assert.ThrowsAny<JwkCheckException>(() => Jwk.Check(json));
            Assert.True(true, description);
        }
